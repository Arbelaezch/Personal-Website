      ...
      <div class="header">
        <div class="top">
          <div id="title" class="title">
            <h1>The Grapes of Wrath (1940)</h1>
          </div>
        ...
        <div class="mid">
          <div id="picture" class="info">
            <img src="../images/grapes.jpg" alt="Grapes of Wrath">
          </div>
          <div id="synopsis" class="info">
            <p class="synopsis"> 
                <br>
                A poor Midwest family is forced off their land. They travel to California, suffering the misfortunes of the homeless in the Great Depression.<br><br>
				Director: John Ford<br><br>
				Writers: Nunnally Johnson, John Steinbeck<br><br>
				Stars: Henry Fonda, Jane Darwell, John Carradine<br><br>
                
				Country: America<br><br>
				
				Producer: Darryl F. Zanuck<br><br>
