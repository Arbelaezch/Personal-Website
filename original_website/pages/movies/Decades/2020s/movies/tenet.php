      ...
      <div class="header">
        ...
        <div class="mid">
          ...
          <div id="synopsis" class="info">
            <p class="synopsis"> 
					<br>
					Armed with only one word, Tenet, and fighting for the survival of the entire world, a Protagonist journeys through a twilight world of international espionage on a mission that will unfold in something beyond real time.<br><br>
					Director: Christopher Nolan<br><br>
					Writer: Christopher Nolan<br><br>
					Stars: John David Washington, Robert Pattinson, Elizabeth Debicki<br><br>
      ...
      <div id="review">
          ...
          <p>
				...
				<br><br>
					...
					<img src="../images/sator.png" alt="Sator Square" style="width:50%; display: block; margin:auto">
