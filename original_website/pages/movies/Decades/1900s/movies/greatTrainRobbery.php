      ...
      <div class="header">
        <div class="top">
          <div id="title" class="title">
            <h1>The Great Train Robbery (1903)</h1>
          </div>
        ...
        <div class="mid">
          ...
          <div id="synopsis" class="info">
            <p class="synopsis"> 
                <br><br>A group of bandits stage a brazen train hold-up, only to find a determined posse hot on their heels.</p>
                
            <p id="info">Director: Edwin S. Porter</p>
            <p id="info">Stars: Gilbert M. 'Broncho Billy' Anderson, A.C. Abadie, George Barnes</p>
            <p id="info">Country of Origin: America<br><br><br><br><br><br><br><br><br><br></p>
