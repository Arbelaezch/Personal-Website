    ...
    <div id="content" class="side">
      <div class="header">
        ...
        <div class="mid">
          <div id="picture" class="info">
            <img src="../images/hisGirl.jpg" alt="His Girl Friday">
          </div>
          <div id="synopsis" class="info">
            <p class="synopsis"> 
					<br>
					A newspaper editor uses every trick in the book to keep his ace reporter ex-wife from remarrying.<br><br>
					Director: Howard Hawks<br><br>
					Writers: Charles Lederer, Ben Hecht<br><br>
					Stars: Cary Grant, Rosalind Russell, Ralph Bellamy<br><br>
									
			
					Country: America<br><br>
					
					Producer: Howard Hawks<br><br>
      ...
      <div id="review">
          <p style="text-align: center; text-indent: -.25in; margin: 30px 1in;"> 
				"Anchored by stellar performances from Cary Grant and Rosalind Russell, His Girl Friday is possibly the definitive screwball romantic comedy."<br>
          ...
          <p>
				...
				His Girl Friday is a 1940s screwball comedy based on the play, <em>The Front Page</em> and is also a remake of the film <em>The Front Page</em> from 1931. Despite no Academy Award nominations, <em>His Girl Friday</em> was a major critical and box office success and still holds a 98% critic's score on Rotten Tomatoes. It also broke records for being the "fastest" film at the time, and boy do the characters talk fast. 
