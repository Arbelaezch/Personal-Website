...
<body>
    ...
    <article class="center">
        ...
        <div class="content">
            <header>
                <h1 class="title">The Silent Era (1878-1929)</h1>
            </header>
            <div id="description" class="mid">
                <div class="horse">
                    <img src="../../images/running horse.gif" alt="running-horse"/>
                </div>
                ...
                <div class="wrapper">
                    ...
                    <div class="item">
                        <a href="./movies/greatTrainRobbery.php" class="grid">
                            ...
                            <p>The Great Train Robbery (1903)</p>
                        </a>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        <a href="./movies/battleshipPotemkin.php" class="grid">
                            ...
                            <p>The Battleship Potemkin (1925)</p>
                        </a>
                    </div>
                    <div class="item">
