      ...
      <div class="header">
        <div class="top">
          <div id="title" class="title">
            <h1>Sunrise: A Song of Two Humans (1927)</h1>
          </div>
        ...
        <div class="mid">
          ...
          <div id="synopsis" class="info">
            <p class="synopsis"> 
                <br>
                An allegorical tale about a man fighting the good and evil within him. 
                Both sides are made flesh - one a sophisticated woman he is attracted to and the other his wife.<br><br>
                Director: F.W. Murnau<br><br>
                Writers: Carl Mayer, Hermann Sudermann<br><br>
                Stars: George O'Brien, Janet Gaynor, Margaret Livingston<br><br>
                

            
                Country of Origin: America<br><br>
                
                Studio: Fox<br><br><br><br><br><br><br><br>
            </p>
          </div>
        </div>
      </div>
